...
const dir = '/Users/localmac/Desktop/Велнокс/velnox-frontend/messages';

try {
  ['en', 'pl', 'uk'].forEach(lang => {
    const file = path.join(dir, `${lang}.json`);
    const data = JSON.parse(fs.readFileSync(file, 'utf8'));
    
    // pl.json gets English text as fallback
    data['oemPage'] = lang === 'uk' ? ukNew : enNew;
